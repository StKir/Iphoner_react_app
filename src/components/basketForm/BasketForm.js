        ...
        <div className='delivery-form'>
            ...
            onSubmit={formik.handleSubmit}>
                ...
                <div className='pay-type'>
                    ...
                    onBlur={formik.handleBlur}
                    >
                        <option value="" disabled selected key="0">Выбрать</option>
                        <option value="Нал" key="1">Наличные</option>
                        <option value="Безнал" key="2">Картой</option>
                    </select>
                </div>
